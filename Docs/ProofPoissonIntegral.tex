...
\[
u(z) = \frac{1}{2\pi} \int_0^{2\pi} \frac{1 - \abs{z}^2}{\abs{e^{it} - z}^2} \, u(e^{it}) \, dt = \frac{1}{2\pi} \int_0^{2\pi} \Re\left(\frac{e^{it}+z}{e^{it}-z}\right) \, u(e^{it}) \, dt
\]
\end{theorem}

The kernel 
\[
P(z, e^{it}) = \frac{1 - \abs{z}^2}{\abs{e^{it} - z}^2} = \Re\left(\frac{e^{it}+z}{e^{it}-z}\right)
\]
...
\begin{proposition}[Poisson Formula for Analytic Functions on Scaled Disc]
\label{prop:poisson_analytic}
Let $f : \C \to E$ be analytic on $\D$, and let $z \in \D$, $r \in (0,1)$. Then
\[
f(rz) = \frac{1}{2\pi} \int_0^{2\pi} \frac{1-|z|^2}{|e^{it}-z|^2} \, f(re^{it}) \, dt = \frac{1}{2\pi} \int_0^{2\pi} \Re\left(\frac{e^{it} + z}{e^{it} - z}\right) \, f(re^{it}) \, dt.
\]
\end{proposition}
...
\[
u(rz) = \frac{1}{2\pi} \int_0^{2\pi} \frac{1-|z|^2}{|e^{it}-z|^2} \, u(re^{it}) \, dt = \frac{1}{2\pi} \int_0^{2\pi} \Re\left(\frac{e^{it} + z}{e^{it} - z}\right) \, u(re^{it}) \, dt.
\]
...
\begin{remark} (The Poisson Formula for Analytic Functions) If $f:\C\to E$ is analytic on $\D$ and continuous on $\overline{D}$, then 
\[
f(z) = \frac{1}{2\pi} \int_0^{2\pi} \frac{1 - \abs{z}^2}{\abs{e^{it} - z}^2} \, f(e^{it}) \, dt = \frac{1}{2\pi} \int_0^{2\pi} \Re\left(\frac{e^{it}+z}{e^{it}-z}\right) \, f(e^{it}) \, dt.
\]
\end{remark}
